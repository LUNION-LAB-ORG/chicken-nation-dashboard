...
export function OrderRow({ order, isSelected, onSelect, onAccept, onReject, onViewDetails, onHideFromList, onRemoveFromList }: OrderRowProps) {
  ...
  return (
    <>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-between items-center mb-2">
                <div className="text-sm font-bold text-[#F17922]">{order.totalPrice.toLocaleString()} F</div>
      ...
      <tr className="hidden md:table-row hover:bg-[#FDEDD3]">
        ...
        <td className="whitespace-nowrap py-3 px-3 sm:px-4">
          <span className="text-sm font-medium">{order.totalPrice.toLocaleString()} F</span>
        </td>
        <td className="whitespace-nowrap py-3 px-3 sm:px-4">
          <StatusBadge status={order.status} />
        </td>
