...
interface PromoStatsServerProps {
  className?: string
...
/**
 * Version Server Component pure de PromoStats
 * Rendu statique sans interactions - pour performance optimale
 */
const PromoStatsServer = ({ className = '', promotions = [] }: PromoStatsServerProps) => {
  // ✅ FONCTIONS HELPER POUR CALCULER LES STATISTIQUES DYNAMIQUES - PURES
  ...
  // ✅ CALCUL DES STATISTIQUES DYNAMIQUES - CALCULS PURS
  ...
  // ✅ CONSTRUCTION DES SECTIONS DYNAMIQUES - RENDU DÉTERMINISTE
...
export default PromoStatsServer 