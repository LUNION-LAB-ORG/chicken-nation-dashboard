...
export default function RestaurantMap({ 
  ...
  }, [initialLat, initialLng, isScriptLoaded, isMapReady, map, isViewOnly]);
            ...
            <div className="relative">
              ...
              >
                <input
                  ...
                  className="w-full pl-10 h-[42px] rounded-xl bg-white border border-[#D8D8D8] px-4 text-[13px] placeholder-gray-400 shadow-md"
                />
              </Autocomplete>
            </div>
          </div>
