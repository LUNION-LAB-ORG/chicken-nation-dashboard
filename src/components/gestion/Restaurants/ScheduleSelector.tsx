...
const TimePicker: React.FC<TimePickerProps> = ({ value, onChange, onClose }) => {
  ...
  return (
    <div 
      ref={pickerRef}
      className="absolute z-50 top-full mt-1 bg-white rounded-lg shadow-lg border border-gray-200 p-3 w-64 max-w-[calc(100vw-40px)]"
      style={{
        left: '50%',
      ...
      <div className="bg-gray-50 p-3 rounded-lg">
        <div className="flex justify-end mb-2">
          <div className="flex flex-wrap gap-1 items-center text-xs">
            ...
            <button
              ...
              className="px-2 py-1 bg-white border border-gray-200 hover:bg-gray-100 rounded-md"
            >
              08:00-22:00
            </button>
            <button
        ...
        {daysOfWeek.map(day => (
          <div key={day.id} className="flex items-center py-1.5 border-b border-gray-100 last:border-b-0">
            <span className="w-20 text-xs font-medium text-gray-600">{day.label}:</span>
            <div className="flex-1 flex items-center">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full h-[30px] rounded-lg bg-white border border-[#D8D8D8] px-2 text-xs cursor-pointer"
                />
              ...
              <div className="flex ml-1">
                <button
                  ...
                  className="w-6 h-[30px] flex items-center justify-center bg-white border border-gray-200 hover:bg-gray-50 rounded-l-md text-[10px] text-gray-500"
                  title="08:00-22:00"
                >
                  ✓
                </button>
                <button
                  ...
                  className="w-6 h-[30px] flex items-center justify-center bg-white border-t border-r border-b border-gray-200 hover:bg-gray-50 rounded-r-md text-[10px] text-red-500"
                  title="Fermé"
                >
                  ✕
                </button>
