...
const RevenueChart: React.FC<RevenueChartProps> = ({ data = [] }) => {
  ...
  const revenueValues = [20, 24, 22, 26, 27, 27, 27, 27, 26, 20];
    ...
    <div className="bg-white rounded-3xl p-3 shadow-sm border border-gray-100">
      <div className="flex justify-between items-center mb-4 mx-4">
        ...
        <div className="text-right">
          <div className="text-[14px] font-bold text-[#9796A1]">273.400 xof</div>
          <div className="text-[10px] font-regular text-green-500">0.5% <span className="text-[#9796A1]">| que hier</span></div>
        </div>
      </div>
