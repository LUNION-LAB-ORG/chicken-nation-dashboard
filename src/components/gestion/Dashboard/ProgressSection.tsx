...
const ProgressSection: React.FC = () => {
  const items = [
    { label: 'Commandes', value: 420.2, color: '#FF6B35' },
    { label: 'Livraisons', value: 320.5, color: '#3B82F6' },
    { label: 'Retours', value: 15.9, color: '#EF4444' },
    { label: 'Autres', value: 20.5, color: '#10B981' },
  ];
