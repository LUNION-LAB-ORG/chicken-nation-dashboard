...
export default function MenuCategories({ categories: propCategories, menuItems: propMenuItems, onEditMenu, onViewMenu }: MenuCategoriesProps) {
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <section>
        ...
        <div className="w-full overflow-x-auto mb-6 bg-[#F4F4F4] p-2 pb-0">
          <div className="flex justify-between min-w-max md:min-w-0 md:flex-wrap gap-y-2">
